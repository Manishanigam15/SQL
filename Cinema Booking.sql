...
CREATE TABLE Seats (
    ...
    room_id INT,
    rownumber CHAR(1),  -- e.g., A, B...
    seat_number INT,     -- e.g., 1, 2...
    FOREIGN KEY (room_id) REFERENCES Rooms(room_id)
);    -- Seats are reserved for a specific screening, not globally.
...
CREATE TABLE Screenings (
    ...
    FOREIGN KEY (room_id) REFERENCES Rooms(room_id)
);    -- Each screening is for a film shown in a room at a specific time
...
);  -- Each booking is for a specific screening.
...
CREATE TABLE Reserved_Seats (
    ...
    FOREIGN KEY (screening_id) REFERENCES Screenings(screening_id)
);       -- A booking reserves multiple seats (via Reserved_Seats).
...
INSERT INTO Seats (rownumber, seat_number, room_id)
...
INSERT INTO customers (first_name, last_name, email,customer_id)
VALUES ('David','May','dmay@gmail.com',2),('Theresa','Davis','tdavis@gmail.com',4),('Jerry','Martin','jermar@gmail.com',6),('John','Smith','smithy@gmail.com',8),
('Martin','Watkins','mwatto@gmail.com',10),('Emma','Watson','itswingardiumleviosa@gmail.com',12),('Javier','Pastore','jp@gmail.com',14),('Charlotte','Hare','chare@gmail.com',16),
('Mark','Smith','markysmith@gmail.com',18),('Emily','Thorne','ethorne@gmail.com',20),('David','Paul','davpaul@gmail.com',22),('Cherry','Wang','cherryw@gmail.com',24),
('Bort','Simpson','mynameisbort@gmail.com',26),('Emma','Connor','econ@gmail.com',28),('Jonathan','Edwards','jedwards@gmail.com',30),('Simon','Davis','sdavis@gmail.com',32),
('Sophie','Marshall','sophmarsh@gmail.com',34),('Sally','Lam','slam@gmail.com',36),('Kenneth','Harrison','kson@gmail.com',38),(NULL,'Smith','smith@gmail.com',40),
('Harry','Weasley','whatsmyname@gmail.com',42),('Ron','Potter','thatsmyname@gmail.com',44),('Ray','Wilkinson','wilky@gmail.com',46),('Samuel','Windsor','royalty@gmail.com',48),
('Jennifer','David','jda@gmail.com',50),('Larry','Davis','larryd@gmail.com',52),('Bolt','Tin','btin@gmail.com',54),('Sarah','Thompson','sthompson1977@gmail.com',56),
('Alan','Bennet','thosewerethedays@gmail.com',58),('Brian','Apple','bapple101@gmail.com',60),('Rob','Bryson','rbry@gmail.com',62),('Shelly','Zu','szu@gmail.com',64),
('Steve','Shoogan','sshoogan@gmail.com',66),('Matthew','Gray','graym@gmail.com',68),('Sally','Kramer','kallysramer@gmail.com',70),('Peter','Chef','chefp@gmail.com',72),
(NULL,'Cooke','nullcooke@gmail.com',74),('Marty','Seinfeld','marfeld@gmail.com',76),('Carl','Green','creen@gmail.com',78),('Emma','Greene','egreene@gmail.com',80),
('Michael','Bannon','mbannon@gmail.com',82),('Paul','Showman','theshowman1@gmail.com',84),('Harry','Goldthistle','hgold@gmail.com',86),('Gill','Newton','gnew@gmail.com',88),
('Preston','Peters','p2p@gmail.com',90),('Simon','Smithson','sismithson@gmail.com',92),('Benjamin','Rabbit','brabbit@gmail.com',94),('Jerry','David','curb@gmail.com',96),
('Olivia','Tulip','otulip@gmail.com',98),('Richard','Horne','richhorne@gmail.com',100),('Betty','Corbe','bcorbe@gmail.com',102),('Anne','Callaway','acway@gmail.com',104),
('Yifan','Way','yway@gmail.com',106),('Charlie','Cheene','ccheene@gmail.com',108),('Ula','Boon','uboon@gmail.com',110),('Buster','David','bdavid@gmail.com',112),
('Dustin','Beer','beerd@gmail.com',114),('John','Sleet','knoweverything@gmail.com',116),('August','Summer','asummer@gmail.com',118),('Linda','Martins','lmart@gmail.com',120),
('Chris','Kay','chkay@gmail.com',122),('Christopher','Roberts','croberts@gmail.com',124),('Robert','Winston','rwin@gmail.com',126),('Daniel','Orbe','dorbe@gmail.com',128),
('Joshua','Wells','wellj@gmail.com',130),('Fred','Flinton','ff100@gmail.com',132),('Paula','Winner','pwinner@gmail.com',134),(NULL,'Canter','canter99@gmail.com',136),
('Michael','Bassett','mbass@gmail.com',138),('Michelle','Martins','mm109@gmail.com',140),('Lorna','Brown','lbrown@gmail.com',142),('Kerry','Vale','wish1985@gmail.com',144),
('Sean','Borne','sborne@gmail.com',146),('Craig','Evans','cevans@gmail.com',148),('Alex','Sanders','asand@gmail.com',150),('George','McNabb','gnabb@gmail.com',152),
('Richard','Trout','redtrout@gmail.com',154),('Stewart','Dee','sdee@gmail.com',156),('Sue','Werkins','swerkins@gmail.com',158),('Mel','Wozniack','mwoz@gmail.com',160),
('Steve','Dole','sdole@gmail.com',162),('Zara','Yelland','zy27@gmail.com',164),('Irene','Mellon','mellonirene@gmail.com',166),('Karen','Wall','kwall@gmail.com',168),
('Lucy','Oak','loak@gmail.com',170),('Orson','Young','oyoung@gmail.com',172),('Oliver','Daniels','odaniels@gmail.com',174),('Queen','Bee','qbee@gmail.com',176),
('Vera','Jack','verajack@gmail.com',178),('Thomas','Soft','softt@gmail.com',180),(NULL,'Blair','nblair@gmail.com',182),('Tim','Jones','tjones@gmail.com',184),
('Nicola','Jenkins','njenk@gmail.com',186),('Olivia','Jones','ojo@gmail.com',188),('James','Depp','jdepp@gmail.com',190),('Meryl','Steep','msteep@gmail.com',192),
('Jake','Portman','jportman@gmail.com',194),('Jenny','Appleton','japple@gmail.com',196),('Simon','Hoover','shoover@gmail.com',198),('Belinda','Marshall','belindam@gmail.com',200),
('Stephanie','Watson','swatson@gmail.com',202),('Art','Simons','simons@gmail.com',204),('Stan','Smith','smithstan@gmail.com',206),('Christopher','Roberts','robertsc@gmail.com',208),
('Nathan','Gold','engold@gmail.com',210),('Alain','Bennet','alainb@gmail.com',212),('Lewis','Russelton','lrus@gmail.com',214),('Josh','Reynolds','jrey@gmail.com',216),
('William','Williams','williamw@gmail.com',218),(NULL,'Pointer','apointer@gmail.com',220),('Bort','Skinner','mynameisalsobort@gmail.com',222),(NULL,'Smith','lonsmith@gmail.com',224),
('Susan','Williams','swill@gmail.com',226),('Yu','Xi','yuxi@gmail.com',228),('Annabelle','Winks','anwinks@gmail.com',230),('Andrew','Landhurst','andylandy@gmail.com',232),
('Winston','Smith','room101@gmail.com',234),('Gemma','Arton','garton@gmail.com',236),('Renton','McDonald','rent@gmail.com',238),('Maggie','Chu','chuchu@gmail.com',240);

INSERT INTO films (title, duration_minutes)
